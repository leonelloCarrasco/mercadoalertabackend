 ...
 * 
 * Por ahora sólo se consideran Licitaciones Públicas, ya que las Privadas corresponden
 * a procesos en donde un comprador invita a proveedores específicos, y no hay un monto mínimo garantizado.
 */
